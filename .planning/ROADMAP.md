...
Plans:
- [ ] 01-01: Закрепить sanitization репозитория и шаблоны конфигурации
- [ ] 01-02: Описать bootstrap для Spreadsheet/App Script/Properties/Triggers на русском
- [ ] 01-03: Проверить публичную публикацию и отсутствие утечек в tracked files и docs
...
|-------|----------------|--------|-----------|
| 1. Публичный GitHub и bootstrap | 0/3 | Not started | - |
