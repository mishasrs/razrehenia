...
- [ ] **BOOT-01**: Разработчик может привязать локальную копию репозитория к своему Apps Script/Spreadsheet через обезличенный пример конфигурации без публикации live `scriptId` и `parentId` в Git
...
- [ ] **BOOT-03**: Публичный репозиторий хранит только обезличенные конфигурационные примеры и не содержит отслеживаемых live secrets, operational ids или привязок к production-окружению
